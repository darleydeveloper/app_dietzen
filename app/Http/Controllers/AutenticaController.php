...
class AutenticaController extends Controller
{
    public function registro(Request $request){
        $request->validate([
            ...
            'Nombre_Empresa_o_Club_Deportivo'=>'required|max:255',
            'Número_de_teléfono_de_contacto'=>'required|int|max:12|unique:users',
            'Disciplina_deportiva_que_practica'=>'required|max:255',
            'address' => 'required',
        ...
        [
            ...
            'Nombre_Empresa_o_Club_Deportivo.required' => 'Mencione la empresa o escuela en la que usted practica un deporte',
            'Número_de_teléfono_de_contacto.required' => 'El número de teléfono es obligatorio',
            'Disciplina_deportiva_que_practica.required' => 'Para qué deporte te quieres vestir y sentir bien', 
        ...
        $user = User::create([
            'name' => $request->name,
            'email' => $request->email,
            'empresa' => $request->Nombre_Empresa_o_Club_Deportivo,
            'telefono' => $request->Numero_de_teléfono_decontacto,
            'deporte' => $request->Disciplina_deportiva_que_practica,
